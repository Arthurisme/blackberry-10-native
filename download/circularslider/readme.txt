HelloCircularSlider - CustomControl

========================================================================
Sample Description.
 
This sample shows how to use CustomControl to create a circular slider that can
be used just like any other core control.
